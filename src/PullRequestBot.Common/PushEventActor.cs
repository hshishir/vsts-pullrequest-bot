...
namespace PullRequestBot.Common
{
    ...
    public abstract class PushEventActor : VSTSEventActor
    {
        protected string BranchName => Id.GetStringId();
        ...
        public PushEventActor(ActorService actorService, ActorId actorId)
